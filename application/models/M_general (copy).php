...
class M_general extends CI_Model {
    ...
    function sumtrxdisplay($field,$value1, $value2, $value3, $value4)
    {
    ...
    function sumtrxwaktu($field,$value1, $value2, $value3, $value4)
    {
    ...
    function counttrxperline($field,$value1, $value2, $value3)
    {
    ...
    function counttrxpermesin($field,$value1, $value2, $value3)
    {
    ...
    public function tampil_trxmasterline($value1, $value2, $value3){
        $this->db->select('*');
        $this->db->from('trx_master');
        $this->db->where('master_produk_id',$value1);
        $this->db->where('master_tgllaporan',$value2);
    ...
    public function tampil_trxmastermesin($value1, $value2, $value3,$value4){
        $this->db->select('*');
        $this->db->from('trx_master');
        $this->db->where('master_produk_id',$value1);
        $this->db->where('master_tgllaporan',$value2);
    ...
    public function tampil_trxmesin($value1, $value2, $value3, $value4){
        $this->db->select('*');
        $this->db->from('trx_mesin');
        $this->db->where('mesin_produk_id',$value1);
        $this->db->where('mesin_tgllaporan',$value2);
    ...
    public function tampil_trxline($value1, $value2, $value3, $value4){
        $this->db->select('*');
        $this->db->from('trx_line');
        $this->db->where('line_produk_id',$value1);
        $this->db->where('line_tgllaporan',$value2);
    ...
    function tampil_trxmasterdetailline($value1, $value2)
    {
    ...
    return $this->db->get()->row()->mxxtotal;
        ...
        function tampil_trxmasterdetailmesin($value1, $value2)
    {
    ...
    public function dropdown_user(){
        $this->db->select('username,user_fullname');
        $this->db->from('tm_assignment');
        $this->db->join('trx_user','tm_assignment.assignment_to=trx_user.username');
        $this->db->group_by('tm_assignment.assignment_to');
        $q=$this->db->get();
        if ($q->num_rows() > 0){
            return $q->result_array();
        }
