    ...
    function batchInsert($data, $codeid, $perbantuan, $username, $usersupervisor){
        ...
        for($i = 0; $i<$count; $i++){
            ...
            $xentries[] = array(
                ...
                'perbantuan_mulai'=>$data['jperbantuan_mulai'][$i],
                'perbantuan_selesai'=>$data['jperbantuan_selesai'][$i],
                'perbantuan_istirahat'=>$data['jperbantuan_istirahat'][$i],
                'perbantuan_totalmenit'=>$total,
            ...
            $yentries[] = array(
                ...
                'masterdetail_mulai'=>$data['jperbantuan_mulai'][$i],
                'masterdetail_selesai'=>$data['jperbantuan_selesai'][$i],
                'masterdetail_istirahat'=>$data['jperbantuan_istirahat'][$i],
                'masterdetail_totalkerja'=>$total,
                'masterdetail_jamkerja' => floor($total/60),
