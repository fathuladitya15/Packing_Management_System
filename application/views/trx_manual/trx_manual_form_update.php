...
<div class="box-body">
    <form action="<?php echo $action; ?>" method="post">
           <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="int">ID Transaksi (*) <?php echo form_error('manual_master_id') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="manual_master_id" id="manual_master_id" placeholder="manual_master_id" value="<?php echo $manual_master_id; ?>" readonly/>
        </div></div>
	    <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="char">Manual Karyawan Id <?php echo form_error('manual_karyawan_id') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="manual_karyawan_id" id="manual_karyawan_id" placeholder="Manual Karyawan Id" value="<?php echo $manual_karyawan_id; ?>"/>
            <input type="hidden" class="form-control" name="codeid" id="codeid" placeholder="manual Id" value="<?php echo $codeid; ?>" />
        </div></div>
        <div class='inline'>
              <div class="form-group">
	       ...
	       <div class='inline'>
            ...
            <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="manual_shift" id="manual_shift" placeholder="manual_shift" value="<?php echo $manual_shift; ?>"/>
            </div>
            </div>
            </div>   
	    <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="int">Jumlah Box <?php echo form_error('manual_box') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="manual_box" id="manual_box" placeholder="Manual Box" value="<?php echo $manual_box; ?>" />
        </div></div>
	    <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="time">Waktu Mulai <?php echo form_error('manual_mulai') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="manual_mulai" id="manual_mulai" placeholder="Manual Mulai" value="<?php echo substr($manual_mulai,0,5); ?>" onkeyup="sum();"/>
        </div></div>
	    <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="time">Waktu Selesai <?php echo form_error('manual_selesai') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="manual_selesai" id="manual_selesai" placeholder="Manual Selesai" value="<?php echo substr($manual_selesai,0,5); ?>" onkeyup="sum();"/>
        </div></div>
	    <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="int">Waktu Istirahat <?php echo form_error('manual_istirahat') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="manual_istirahat" id="manual_istirahat" placeholder="Manual Istirahat" value="<?php echo $manual_istirahat; ?>" onkeyup="sum();"/>
        </div></div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="date">Tanggal laporan (*)<?php echo form_error('manual_tgllaporan') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="manual_tgllaporan" id="manual_tgllaporan" placeholder="Manual Tgllaporan" value="<?php echo $manual_tgllaporan; ?>" readonly />
        </div></div>
