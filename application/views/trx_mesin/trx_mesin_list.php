...
<div class="box box-default">
  ...
  <div class="box-body">
    <div class='row'>
      <div class='col-xs-12'>
        <form action="<?php echo site_url('trx_mesin/index'); ?>" method="get" name="search" action="">
          <div class="input-group input-group-sm">
            ...
            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('trx_mesin'); ?>" class="btn btn-default">x</a>
                                    <?php
                                }
                            ?>
...
<div class="box box-default">
  <div class="box-header with-border">
    ...
    <div class="box-tools pull-right">
      <a href="<?php echo base_url() ."trx_mesin"; ?>" type="button" class="btn btn-box-tool"><i class="fa fa-refresh fa-spin"></i></a>
      <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
      <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
    </div>
  </div>
  <div class="box-body">
        <?php                 
            if(!empty($add)){
                  if($add=='Y'){ ?>
        <a class='btn btn-success' href="<?php echo base_url(); ?>trx_mesin/create"><span class="fa fa-plus-circle">Tambah</span></a>
        <?php } } ?>

        <?php                 
          if(!empty($plus)){
            if($plus=='Y'){ ?>
                <a class='btn btn-warning' href="<?php echo base_url(); ?>trx_mesin/plus"><span class="fa fa-plus-circle">Manual</span></a>
            <?php } } ?>

            <?php if($report=='Y') { ?>
            <div class="pull-right">
              <form method="POST" action="<?php echo base_url() ."trx_mesin/download"; ?>">
                <div class="input-group input-group-sm" >
        ...
        <th><input type="checkbox"></th>
            ...
            foreach ($trx_mesin_data as $trx_mesin)
            {
                ?>
                <tr>
                <td width="20px"><input type="checkbox"></td>
          			<td width="40px"><?php echo ++$start ?></td>
          			<td><?php echo $trx_mesin->mesin_karyawan_id ?></td>
                <td><?php echo $trx_mesin->karyawan_nama ?></td>
          			<td><?php echo $trx_mesin->produk_id . " | " . $trx_mesin->produk_nama ?></td>
                <td><?php echo $trx_mesin->acuan_nama ?></td>
          			<td><?php echo $trx_mesin->mesin_shift ?></td>
                <td><?php echo $trx_mesin->mesin_mesin ?></td>
                <td><?php echo $trx_mesin->mesin_line ?></td>     			
          			<td><?php echo $trx_mesin->mesin_display ?></td>
          			<td><?php echo substr($trx_mesin->mesin_mulai,0,5); ?></td>
          			<td><?php echo substr($trx_mesin->mesin_selesai,0,5); ?></td>
                <td><?php echo substr($trx_mesin->mesin_istirahat,0,5); ?></td>
                <td><?php echo $trx_mesin->mesin_upah ?></td>
          			<td><?php echo $trx_mesin->mesin_tgllaporan ?></td>    			
            <td style="text-align: center; width: 100px;">
                  
                <a href="<?php echo base_url() ."trx_mesin/read/" .$trx_mesin->mesin_id;?>">
                ...
                if(!empty($update)){
                  if($update=='Y'){
                ?>  <a href="<?php echo base_url() ."trx_mesin/update/" .$trx_mesin->mesin_id;?>">
                ...
                if(!empty($delete)){
                  if($delete=='Y'){
                ?>
                  <a onclick='return konfirmasi()' href="<?php echo base_url() ."trx_mesin/delete/" .$trx_mesin->mesin_id;?>" >
