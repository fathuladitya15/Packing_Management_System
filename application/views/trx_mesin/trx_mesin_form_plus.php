...
<div class="box box-default">
  <div class="box-header with-border">
    <h3 class="box-title">PLUS MESIN FORM</h3>
...
<div class="box-body">
    <form action="<?php echo $action; ?>" method="post">
	   <div class="form-group">
            ...
            <input type="text" class="form-control" name="mesin_master_id" id="mesin_master_id" placeholder="mesin master" value="<?php echo $mesin_master_id; ?>" required=""/>
        </div></div>
      <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="char">ID Karyawan<?php echo form_error('mesin_karyawan_id') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="mesin_karyawan_id" id="mesin_karyawan_id" placeholder="mesin Karyawan Id" value="<?php echo $mesin_karyawan_id; ?>" required=""/>
        </div></div>
        <div class='inline'>
              <div class="form-group">
	       ...
	       <div class='inline'>
            ...
            <div class="col-sm-9 col-xs-12">
              <select class="form-control input-sm select2" name="mesin_shift">
                <?php 
                foreach($shift as $g){?>
	    ...
	    <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="int">Jumlah Display <?php echo form_error('mesin_display') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="mesin_display" id="mesin_display" placeholder="mesin Box" value="<?php if(!empty($mesin_display)) echo $mesin_display; else echo '1'; ?>" required=""/>
        </div></div>

              <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="time">No. Line <?php echo form_error('mesin_line') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="mesin_line" id="mesin_line" placeholder="mesin Mulai" value="<?php if(!empty($mesin_line)) echo $mesin_line; else echo '1'; ?>" required=""/>
        </div></div>
      <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="time">No. Mesin <?php echo form_error('mesin_mesin') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="mesin_mesin" id="mesin_mesin" placeholder="No Mesin" value="<?php if(!empty($mesin_mesin)) echo $mesin_mesin; else echo '1'; ?>" required=""/>
        </div></div>

	    <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="time">Watu Mulai <?php echo form_error('mesin_mulai') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="mesin_mulai" id="mesin_mulai" placeholder="mesin Mulai" value="<?php if(!empty($mesin_mulai)) echo $mesin_mulai; else echo '07:00'; ?>"  onkeyup="sum();" required=""/>
        </div></div>
	    <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="time">Waktu Selesai <?php echo form_error('mesin_selesai') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="mesin_selesai" id="mesin_selesai" placeholder="mesin Selesai" value="<?php if(!empty($mesin_selesai)) echo $mesin_selesai; else echo '17:00'; ?>"  onkeyup="sum();" required=""/>
        </div></div>
	    <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="int">Waktu Istirahat <?php echo form_error('mesin_istirahat') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="mesin_istirahat" id="mesin_istirahat" placeholder="mesin Istirahat" value="<?php if(!empty($mesin_istirahat)) echo $mesin_istirahat; else echo '0'; ?>" onkeyup="sum();" required=""/>
        </div></div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="date">Tanggal Laporan (*) <?php echo form_error('mesin_tgllaporan') ?></label>
             <div class="col-sm-9 col-xs-12">
            <input type="text" class="form-control" name="mesin_tgllaporan" id="datepicker" placeholder="mesin Tgllaporan" value="<?php echo $mesin_tgllaporan; ?>" required=""/>
        </div></div>
