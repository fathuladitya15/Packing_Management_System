...
<div class="box-body">
      ...
      <div class="form-group">
            ...
            <input type="text" class="form-control" name="karyawan_email" id="karyawan_email" placeholder="Email Karyawan" value="<?php echo $karyawan_email; ?>" />
              ...
              <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="varchar">KTempat & Tanggal lahir <?php echo form_error('karyawan_tempatlahir') ?></label><div class="col-sm-9 col-xs-12">
      ...
      <div class="form-group">
	    ...
	    <div class='inline'>
          <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <?php 
                echo form_dropdown('kelamin', $kelamin, $karyawan_jk);  ?>   
            </div>
          </div>
        </div>
	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="karyawan_username" id="karyawan_username" placeholder="Username Karyawan" value="<?php echo $karyawan_username; ?>" readonly/>
        </div></div>
	    <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-sm-3 col-xs-12 control-label" for="varchar">Deskripsi Karyawan <?php echo form_error('karyawan_deskripsi') ?></label><div class="col-sm-9 col-xs-12">
