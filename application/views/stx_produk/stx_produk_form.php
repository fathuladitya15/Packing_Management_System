...
<div class="box-body">
      ...
      <div class="form-group">
            ...
            <input type="text" class="form-control" name="produk_id" id="produk_id" placeholder="Tambahan Kode Produk, Misal Yupi1 : Y1 | Yupi3 : Y3 | Yupi4 : Y4" value="<?php echo $produk_id; ?>" required=""/>
        </div></div>
	    <div class="form-group">
