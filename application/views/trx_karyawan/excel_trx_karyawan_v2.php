...
<table border="1">
  ...
  <?php
    ...
    <tr>
      ...
      <td  class='str'><?php echo $d['karyawan_telp'];?></td>
      <td><?php echo $d['karyawan_norek'];?></td>
      <td><?php echo $d['karyawan_norek_an'];?></td>
      <td><?php echo $d['karyawan_status'];?></td>
      <td  class='str'><?php echo $d['karyawan_deskripsi'];?></td>
      <td><?php echo $d['karyawan_pendidikan'];?></td>
      <td><?php echo $d['karyawan_nikah'];?></td>
      <td  class='str'><?php echo $d['karyawan_bpjskesehatan'];?></td>
      <td  class='str'><?php echo $d['karyawan_bpjstenagakerja'];?></td>
