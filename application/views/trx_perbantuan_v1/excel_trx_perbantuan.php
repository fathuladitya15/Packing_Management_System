...
header("Content-Disposition: attachment; filename=Trx_perbantuan_" .date('Ymd_hms') .".xls");
...
<table border="1">
  <thead>
    ...
    <tr>
      <td colspan="14" style="text-align: center;">LAPORAN MODULE PERBANTUAN : <?php echo $tgl_awal; ?> To <?php echo $tgl_akhir; ?></td>
    </tr>
    <tr>
  ...
  <?php
    ...
    <tr>
      ...
      <td></td>
      <td></td>      
      <td><?php echo substr($d['perbantuan_mulai'],0,5);?></td>
      <td><?php echo substr($d['perbantuan_selesai'],0,5);?></td>
