...
<div class="box-body">
        <table class="table">
        <tr><td>ID Karyawan</td><td><?php echo $karyawan_id; ?></td></tr>
        <tr><td>Nama Karyawan</td><td><?php echo $karyawan_nama; ?></td></tr>
	    <tr><td>Master Acuan Id</td><td><?php 
            ...
            ?></td></tr>
	    <tr><td>Produk</td><td><?php echo $produk_id . " | " . $produk_nama; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('trx_master') ?>" class="btn btn-danger pull-right">Cancel</a></td></tr>
	</table>
</div></div>
