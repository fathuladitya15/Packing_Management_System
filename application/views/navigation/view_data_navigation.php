...
<div class="box box-default">
  <div class="box-header with-border">
    <h3 class="box-title">List Of Navigation</h3>

    <div class="box-tools pull-right">
      <a href="<?php echo base_url() ."navigation"; ?>" type="button" class="btn btn-box-tool"><i class="fa fa-refresh fa-spin"></i></a>
      <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
      <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
    </div>
  </div>
  ...
  <div class='row'>
    <div class='col-xs-12'>
      <div class='box'>
        ...
        <div class='box-body'>
        <a class='btn btn-primary' href="<?php echo base_url(); ?>navigation/form"><span class="fa fa-plus-circle"></span>&nbsp; Add</a>
          ...
          <table id='dataadmin1' class='table table-bordered table-striped'>
            <thead>
              <tr>
                ...
                <th>Title</th>
                <th>Url</th>
                <th width="80px">Parent Idx</th>
                <th width="80px">Child Idx</th>
            ...
            <?php
              ...
              <tr>
                <td><?php echo $no; ?></td>
                <td><?php echo $d['nav_title'];?></td>
                <td><?php echo $d['nav_url'];?></td>
                <td><?php echo $d['parent_idx'];?></td>
                <td><?php echo $d['child_idx'];?></td>
                <td>
                <?php 
                if($d['status']=='Active'){
                ?>
                ...
                if(!empty($update)){
                  if($update=='Y'){
                ?>
                  <a href="<?php echo base_url() ."navigation/form/" .$d['id_nav'];?>">
                ...
                if(!empty($delete)){
                  if($delete=='Y'){
                ?>  
                  <a onclick='return konfirmasi()' href="<?php echo base_url() ."navigation/remove/" .$d['id_nav'];?>">
