    ...
    <form method="POST" action="<?php echo $action; ?>" id="frm_submit">
           ...
           <label class="col-sm-2 col-xs-12 control-label" >Shift</label>
            <div class="col-sm-3 col-xs-12">
              <select class="form-control input-sm select2" name="perbantuan_shift" id="perbantuan_shift">
                <?php 
                foreach($shift as $g){?>
            ...
            <div class="alert alert-dismissable alert-danger"  style="display: none">
                ...
                <strong>Ada kesalahan , Mohon di ulang kebali</strong>
                        ...
                        <table style="width: 100%;" class="table">
                            <thead style="background-color: #ddd;"><tr><th>No.</th><th>ID Karyawan</th><!-- <th>Waktu Mulai</th><th>Waktu Selesai</th> --><th>Jam Kerja</th></tr></thead>
